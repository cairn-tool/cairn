---
name: cairn-markdown-markdown-navigate
...
see the `cairn-markdown-markdown-refactor` skill before using it.
...
updates those references for you — see `cairn-markdown-markdown-refactor`.

## More

Whole-workspace questions — querying many documents at once, building a context pack, the
reference graph — belong to the `cairn-markdown-markdown-query` skill. Full flag tables for the commands here
