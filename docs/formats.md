...
| --------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------ |
| [Agent bundle format and syntax](formats/agent-bundle.md) | `agent-bundle.yaml`                                                        | `schemaVersion` (hand-owned)                 | authors                              |
...
| [Release manifest](formats/release-manifest.md)           | `release-manifest.json`                                                    | `schemaVersion` (hand-owned)                 | `agent marketplace --layout release` |
| [Install manifest](formats/install-manifest.md)           | `.cairn-install.json`                                                      | unversioned; shape-checked                   | `agent install`                      |
| [QA case file](formats/qa-case-file.md)                   | `_plans/tc-N.yaml`                                                         | unversioned; shape-checked                   | authors                              |
