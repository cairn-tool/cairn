...
| [`agent guard`](commands/agent/guard.md)                            | Report whether a path is cairn-generated, and which bundle file to edit instead. |
| [`agent specs`](commands/agent/specs.md)                            | Print the versioned target conformance profiles.                                 |
| [`agent docs <source>`](commands/agent/docs.md)                     | Emit the documentation artifact for an inline agent bundle.                      |
| [`agent collection-docs [spec]`](commands/agent/collection-docs.md) | Emit one documentation artifact for every installable bundle in a collection.    |
