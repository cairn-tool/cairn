...
See [the store](common.md#the-usage-store) for what each is for and how to query the
second.
...
- [`usage index`](index.md) reports on the store this fills.
- [`usage migrate`](migrate.md) moves the store between schema versions.
