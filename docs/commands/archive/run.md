...
See [what gets archived](common.md#what-gets-archived) for the per-provider sets and why
...
- [`archive status`](status.md) reports what the archive holds afterwards.
- [`archive verify`](verify.md) checks it against its index.
