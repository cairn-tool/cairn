...
Run the script named in `the invocation arguments from the user's message`.

1. If `the invocation arguments from the user's message` is empty, run `cairn scripts list` and show what is available.
