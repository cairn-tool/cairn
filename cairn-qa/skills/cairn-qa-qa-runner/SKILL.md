...
[`reference/running.md`](reference/running.md). The case file itself is the `cairn-qa-qa-case-plan` skill; the
records a run leaves behind are `cairn-qa-qa-run-record`.
