---
name: cairn-agent-bundle-authoring
...
[`reference/bundle-format.md`](reference/bundle-format.md). Testing is the `cairn-agent-bundle-testing`
skill; packaging and installing are `cairn-agent-bundle-publishing`.
